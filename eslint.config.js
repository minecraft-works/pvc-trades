...
export default tseslint.config(
    ...
    sonarjs.configs.recommended,
    {
        ...
        languageOptions: {
            ...
            parserOptions: {
                projectService: {
                    allowDefaultProject: ['*.test.ts', 'src/*.test.ts', 'src/stores/*.test.ts', 'src/map/*.test.ts', 'src/dialogs/*.test.ts', 'src/chatlog/*.test.ts', 'tests/*.spec.ts', 'tests/helpers/*.ts', 'features/*.ts', 'features/steps/*.ts', 'features/support/*.ts', 'features/step-definitions/*.ts', 'scripts/*.ts'],
